    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Real Object · Slinky (ไม่ซ้ำกับแผนอื่น)',
        ...
        { cls:'e4', no:'11', t:'ใบงาน Calc · Math Builder (5 ข้อ)', file:'สื่อ11_Calc_ใบงาน1.1.html',
          d:'โจทย์คำนวณ 5 ข้อ · canvas วาดวิธีคิด · self-check · ไล่ระดับ',
  ...
  2: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Photo Stimulus · เชือก 4 แบบ (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  3: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Video Analysis · ripple tank (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  4: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: POE Demo · 2 คลื่นพบกัน (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  5: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Anticipation Guide · 6 ข้อสะท้อน (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  6: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Case Study · ดำน้ำเห็นปลา (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  7: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Mystery · Bose NC (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  8: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Real Object · เสียงรอบมุมตึก (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  9: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Story · เด็กบนชิงช้า (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
  ...
  10: {
    ...
    sections: [
      ...
      { title: '🎨 สื่อการสอน (ใช้ในกิจกรรม)', items: [
        ...
        { cls:'e1', no:'0', t:'🚀 เกริ่นนำ + ทบทวนความรู้เดิม', file:'สื่อ00_Engage_เกริ่นนำ.html',
          d:'ความรู้เดิม + Engage type: Gallery Walk · 6 สถานี Synthesis (ไม่ซ้ำกับแผนอื่น)',
          meta:'15-20 นาทีแรก · ก่อน E1',
          chips:[['','Activate Prior'],['w','วPA 2 ⭐']] },
