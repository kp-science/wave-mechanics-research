...
window.KP_WORKSHEETS = {
  ...
  3: {
    ...
    // CER Board (Phase 7) · ใช้ใน E3 Explain แทน Gallery walk
    cer: {
      id: 'cer',
      title: 'CER Board · Phase E3',
      description: 'เสนอข้อค้นพบจาก 3 ฐาน · เลือกคอลัมน์ที่ตรง · เขียน Claim/Evidence/Reasoning + แนบรูป/วาดประกอบ',
      columns: [
        { id:'v',     label:'⚡ v เท่ากัน (ดล/ต่อเนื่อง)', color:'#ef6c00' },
        { id:'phase', label:'✅ เฟสตรงกัน (in-phase)',    color:'#2e7d32' },
        { id:'anti',  label:'🔄 เฟสตรงข้าม (anti-phase)', color:'#c62828' }
      ],
      prompts: {
        claim:     'เช่น: คลื่นดลกับคลื่นต่อเนื่องเคลื่อนที่ด้วย v เท่ากันในเชือกเส้นเดียวกัน',
        evidence:  'เช่น: ฐาน 1 Slinky วัด pulse ได้ 4.2 m/s · ต่อเนื่องได้ 4.1 m/s (ต่างกัน < 3%)',
        reasoning: 'เช่น: v ขึ้นกับคุณสมบัติของตัวกลาง (T, μ) เท่านั้น · ลักษณะการรบกวนไม่มีผลต่อ v'
      },
      allowImage: true,
      sheetPrefix: 'CER_P'
    }
