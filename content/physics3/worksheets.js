...
window.KP_WORKSHEETS = {
  ...
  // ───────── แผน 8 · การเลี้ยวเบนของคลื่น ─────────
  8: {
    poe: {
      title:       'POE-08 · ใบบันทึก Predict–Observe–Explain (แผน 8)',
      description: 'Interactive: canvas วาดหน้าคลื่น 3 ช่อง (แคบ/ปานกลาง/กว้าง) · MC Reflection 3-part · Sim: Lab 41 โหมดช่องแคบเดียว',
      viewFile:    'สื่อ02_POE-08_ใบบันทึกPOE.html',
      submitLabel: '📤 ส่ง POE-08',
      sheetPrefix: 'POE_P',
      misconception: 'M8.1 · M8.2 · M8.3',
      allowUpload: true,
      hero: {
        question: 'คลื่นน้ำผ่านช่อง 3 ขนาด (d < λ · d ≈ λ · d > λ) · หน้าคลื่นหลังช่องโค้งแค่ไหน? · f เปลี่ยนไหม?',
        context:  'คู่กับ Hook "เสียงคุยรอบมุมตึก" + 3 ฐาน (Sim Lab 41 · โหมดช่องแคบเดียว · a = 1, 3, 10 cm)'
      }
    },
    calc: {
    ...
    spot: {
      title:       'ใบกิจกรรม 8.2 · Spot the Error',
      description: '3 สถานการณ์ · "ช่องแคบ<λ คลื่นผ่านไม่ได้" (M8.1) · "ช่องกว้าง=เลี้ยวเบนมาก" (M8.2) · "เลี้ยวเบนทำให้ f เปลี่ยน" (M8.3) · claim canvas overlay + canvas อธิบายที่ถูก',
      viewFile:    'สื่อ04_Spot_ใบกิจกรรม8.2.html',
      items: [
        { misc:'M8.1', stmt:'น้องพลอย: "ถ้าช่องเปิดในกำแพงกว้างแค่ 1 cm แต่ความยาวคลื่นน้ำ λ = 3 cm · แปลว่าช่องแคบกว่าคลื่น คลื่นจึงไม่สามารถผ่านช่องได้เลย · จะถูกกำแพงกั้นหมด"' },
        { misc:'M8.2', stmt:'พี่เจมส์: "ยิ่งช่องเปิดกว้างมาก คลื่นยิ่งมีที่ให้แผ่ออกไป เพราะฉะนั้นช่องที่กว้าง 10 cm จะเลี้ยวเบนมากกว่าช่อง 1 cm อย่างแน่นอน"' },
        { misc:'M8.3', stmt:'น้องโบ: "คลื่นน้ำ f = 10 Hz ผ่านช่องแคบแล้วเลี้ยวเบน · หน้าคลื่นหลังช่องโค้งออก ทำให้ f หลังช่องต้องเพิ่มเป็น ~15 Hz เพราะการเลี้ยวเบนบีบให้คลื่นถี่ขึ้น"' }
      ],
      submitLabel: '📤 ส่งใบกิจกรรม 8.2',
      sheetPrefix: 'Spot_P'
    },
    cer: {
      id: 'cer',
      title: 'CER Board · Phase E3',
      description: 'ใช้ข้อมูลจาก POE-08 ทั้ง 3 ฐาน (ช่อง a = 1, 3, 10 cm) · ทุกกลุ่มส่ง CER พร้อมกัน · ครูฉายบนจอเพื่อเปรียบเทียบ',
      columns: [
        { id:'narrow', label:'🔸 ช่องแคบ d ≤ λ · แก้ M8.1', color:'#db2777',
          prompts: {
            claim:     '👉 ช่องแคบกว่า λ คลื่นผ่านได้หรือไม่ · เลี้ยวเบนมากหรือน้อย?',
            evidence:  '👉 ฐาน 1: a = 1 cm · λ = ___ · สังเกตหน้าคลื่นหลังช่อง = ___',
            reasoning: '👉 อธิบายด้วยหลักฮอยเกนส์ · ทุกจุดในช่องเป็นแหล่ง wavelet · d ≤ λ ให้วงกลมกว้าง'
          } },
        { id:'wide', label:'🔹 ช่องกว้าง d ≫ λ · แก้ M8.2', color:'#9d174d',
          prompts: {
            claim:     '👉 ช่องกว้างกว่า λ มาก ๆ เลี้ยวเบนมากหรือน้อย?',
            evidence:  '👉 ฐาน 3: a = 10 cm · สังเกต = ___ · เทียบกับช่อง 1 cm = ___',
            reasoning: '👉 d ≫ λ → wavelet หลายตัวรวมเป็น envelope แบน · เดินตรงเกือบเต็ม · เลี้ยวเบนเฉพาะขอบ'
          } },
        { id:'freq_keep', label:'🔁 f ไม่เปลี่ยน · แก้ M8.3', color:'#831843',
          prompts: {
            claim:     '👉 การเลี้ยวเบนเปลี่ยน f, v, λ หรือไม่?',
            evidence:  '👉 f ก่อน = ___ · f หลัง = ___ · v = ___ · λ = ___ (วัดก่อน–หลังช่อง)',
            reasoning: '👉 f กำหนดโดยแหล่งกำเนิด · v, λ กำหนดโดยตัวกลาง · ช่องไม่ใช่ตัวกลางใหม่ · เปลี่ยนเฉพาะทิศหน้าคลื่น'
          } }
      ],
      prompts: {
        claim:     'ข้อค้นพบสั้น ๆ...',
