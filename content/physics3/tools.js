...
window.KP_PLAN_TOOLS = {
  1: ['tl-pre','ft01','f1-pre','poe','matrix','spot','tl-post','f1-post','mj','upload'],
  ...
  5: ['tl-pre','f5-pre','poe','cer','calc','spot','tl-post','f5-post','mj','upload'],
  6: ['tl-pre','f6-pre','poe','cer','calc','spot','tl-post','f6-post','mj','upload'],
...
window.KP_TOOL_DEFS = {
  ...
  'poe':     { ico:'🔮', name:'POE · ใบบันทึก', desc:'บันทึก Predict · Observe · Explain', sheet:'POE', color:'tc-poe' },
  ...
  'ft01':    { ico:'📋', name:'FT-01 Pre-test หลัก', desc:'ข้อสอบมโนทัศน์รวม 20 ข้อ Four-tier · ก่อนเริ่มเรียน', sheet:'FT01', color:'tc-ft' },
