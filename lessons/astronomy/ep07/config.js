...
window.EP_CONFIG = {
  ...
  /* ===== Pretest 8 ข้อ ===== */
  // Pre-test 5 ข้อ · misconception (M) + วัตถุประสงค์ K (EM spectrum + วงโคจร)
  pretest: [
    { q:'ดาวเทียม geostationary ที่ระยะ 35,786 km เหนือเส้นศูนย์สูตรเคลื่อนที่อย่างไร?',
      opts:['ลอยนิ่งสนิทไม่เคลื่อนที่','หมุนตามโลกที่ความเร็ว ~3 km/s','ตกฟรีโดยไม่หมุน','สั่นในที่เฉยๆ'], answer:1, tag:'M1' },
    { q:'ดาวเทียมยิ่งโคจรสูง · ความเร็วเป็นอย่างไร (ตามกฎ Kepler)?',
      opts:['ยิ่งเร็วขึ้น','เท่าเดิมทุกระดับ','ยิ่งช้าลง','เปลี่ยนแปลงสุ่ม'], answer:2, tag:'M3' },
    { q:'หลังจรวดเข้าวงโคจรแล้วต้องเปิดเครื่องยนต์ดันต่อไหม?',
      opts:['ต้องดันตลอดเวลา','ไม่ต้อง · inertia พาให้โคจรต่อ','ต้องดันเป็นพักๆ','ใช้ใบเรือสุริยะ'], answer:1, tag:'M4' },
    { q:'ระบบ GPS ใช้สัญญาณจากดาวเทียมอย่างน้อยกี่ดวงเพื่อระบุพิกัด 3 มิติ?',
      opts:['1 ดวง','2 ดวง','3 ดวง','4 ดวง'], answer:3, tag:'M5' },
    { q:'กล้องโทรทรรศน์บนพื้นโลกรับคลื่นแม่เหล็กไฟฟ้าช่วงใดได้ดีที่สุด?',
      opts:['รังสีเอกซ์ (X-ray)','รังสีอัลตราไวโอเลต (UV)','คลื่นวิทยุ + ไมโครเวฟ','รังสีแกมมา'], answer:2, tag:'M6' }
  ],
