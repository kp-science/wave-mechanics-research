...
window.EP_CONFIG = {
  ...
  /* ===== Pretest 8 ข้อ ===== */
  pretest: [
    { q:'ดาวเทียม geostationary @ 35,786 km · เคลื่อนที่อย่างไร?',
      opts:['ลอยนิ่ง','หมุนตามโลกที่ 3 km/s','ตกฟรีโดยไม่หมุน','สั่นในที่'], answer:1, tag:'M1' },
    { q:'กล้องบนพื้นโลกรับคลื่นอะไรได้ดีที่สุด?',
      opts:['X-ray','UV','วิทยุ + ไมโครเวฟ','รังสีแกมมา'], answer:2, tag:'M6' },
    { q:'ดาวเทียมยิ่งสูง · ความเร็วเป็นอย่างไร?',
      opts:['ยิ่งเร็ว','เท่าเดิม','ยิ่งช้า','สุ่ม'], answer:2, tag:'M3' },
    { q:'GPS ใช้สัญญาณดาวเทียมกี่ดวงเพื่อระบุพิกัด 3 มิติ?',
      opts:['1','2','3','4'], answer:3, tag:'M5' },
    { q:'หลังจรวดเข้า orbit แล้วต้องดันต่อไหม?',
      opts:['ต้องดันตลอด','ไม่ต้อง · inertia พา','ต้องดันบางครั้ง','ใช้ใบเรือ'], answer:1, tag:'M4' },
    { q:'แอโรเจลพัฒนาขึ้นเพื่ออะไร?',
      opts:['ของเล่น','ภารกิจอวกาศ NASA','สิ่งทอ','พลาสติก'], answer:1, tag:'M7' },
    { q:'ทำไมกล้อง Hubble อยู่ในอวกาศ ไม่อยู่บนโลก?',
      opts:['เพื่อความเก่ง','เพราะบรรยากาศบิดเบือน+ดูดกลืนคลื่น','เพราะไม่มีไฟ','เพราะตกบนโลก'], answer:1, tag:'M6' },
    { q:'ปั๊มหัวใจขนาดเล็กที่ รพ. ใช้ มีรากจากเทคโนฯ อะไร?',
      opts:['เครื่องซักผ้า','รถยนต์','ภารกิจอวกาศ','โทรศัพท์'], answer:2, tag:'M7' }
  ],
