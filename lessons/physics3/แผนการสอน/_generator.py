...
UNITS = [
    ("waves",  "หน่วยที่ 1 คลื่นกล",           "บทที่ 9 คลื่นกล",      "ม.5", "ว 5.2 ม.5/1-5",  10),
    ("SHM",    "หน่วยที่ 2 การเคลื่อนที่แบบฮาร์มอนิกอย่างง่าย", "บทที่ 11 SHM",       "ม.5", "ว 5.2 ม.5/3",     6),
    ("sound",  "หน่วยที่ 3 เสียง",             "บทที่ 12 เสียง",      "ม.5", "ว 5.2 ม.5/4-7",  11),
    ("light",  "หน่วยที่ 4 แสงเชิงคลื่น",       "บทที่ 10 แสงเชิงคลื่น", "ม.5", "ว 2.3 ม.5",      3),
]
